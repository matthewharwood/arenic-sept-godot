...
| Transient | Arena-clock seek revisions used to invalidate music playback. | Rebuild with restored clocks; never serialize. Ordinary forward ticks do not trigger decoder restarts, regardless of rendered frame duration. |
